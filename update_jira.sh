...
if [ -f "$ARTIFACT_LOCATION" ]; then
    ...
    COMMENT_BODY="Latest Artifact link: [jiracon22-1.0.0.war](https://output.circle-artifacts.com/output/job/${CIRCLE_WORKFLOW_JOB_ID}/artifacts/0${ARTIFACT_LOCATION})"
